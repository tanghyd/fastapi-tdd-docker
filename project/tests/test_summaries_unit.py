...
# unit tests will be faster, but we rely on integration/e2e tests for db
...
def test_create_summaries_invalid_json(test_app):
    # test whether json provided has all valid keys
...
@pytest.mark.parametrize(
    ...
    [
        ...
        [
            1,
            {"url": "https://foo.bar"},  # missing keys
            422,
            [
                {
                    "loc": ["body", "summary"],
